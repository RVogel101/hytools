...
class TestWaScoreUnitExtras(unittest.TestCase):
    ...
    def test_wa_neg_prefix_che(self):
        # ՉԵՄ ԳՆՈՒՄ (negative prefix form in WA)
        text = "\u0579\u0565\u0574 \u0563\u0576\u0578\u057e\u0574"  # Չեմ գնում
        result = classify_text_classification(text)
        self.assertEqual(result.get("label"), "likely_western")
    ...
    def test_wa_vocabulary_dgha_vs_tgha(self):
        result_dgha = classify_text_classification("\u057f\u0572\u0561\u0575")  # տղայ
        result_tgha = classify_text_classification("\u057f\u0572\u0561")  # տղա
        self.assertEqual(result_dgha.get("label"), "likely_western")
        self.assertNotEqual(result_tgha.get("label"), "likely_western")

    def test_wa_vocabulary_haba(self):
        result_hapa = classify_text_classification("\u0570\u0561\u057a\u0561")  # հապա
        self.assertEqual(result_hapa.get("label"), "likely_western")
