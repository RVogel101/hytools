...
def test_metadata_serialization():
    ...
    assert data["dialect"] == "western_armenian"
    ...
    assert decoded["dialect"] == "western_armenian"
...
def test_corpus_metadata_tagger_configs():
    ...
    assert aravot_config["dialect"] == Dialect.EASTERN_ARMENIAN
    assert aravot_config["language_code"] == "hye"
