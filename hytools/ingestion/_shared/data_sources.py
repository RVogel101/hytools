...
from hytools.core_contracts import DocumentRecord
...
def get_news_documents(data_dir: Path | None = None) -> Iterable[DocumentRecord]:
    ...
    if data_dir is None:
        raise NotImplementedError(
            ...
            "Pass data_dir or see extraction.data_sources for integration guidelines."
        )
...
def get_news_sources() -> list[dict]:
    ...
    try:
        from hytools.ingestion.acquisition.news import _NEWSPAPER_ALL_SOURCES
    ...
    try:
        from hytools.ingestion.acquisition.news import NEWS_AGENCIES
    ...
    try:
        from hytools.ingestion.acquisition.news import ALL_RSS_SOURCES
